...
\begin{multicols}{2} % This is how many columns your poster will be broken into, a portrait poster is generally split into 2 columns
 ...
 \begin{minipage}{0.33\linewidth}
  \begin{flushleft}
   \large\qquad\textbf{Standard Model}
  \end{flushleft}
 \end{minipage}%
 \quad
 \begin{minipage}{0.33\linewidth}
 ...
 % \begin{center}
 %  \begin{tikzpicture}
 %   \node[circle,draw,inner sep=2cm,fill overzoom image=collaborators/feickert.jpg] (A) {};
 %  \end{tikzpicture}
 %  Feickert
 % \end{center}
 % \end{minipage}%
 ...
 %  \begin{center}
 %   \begin{tikzpicture}
 %    \node[circle,draw,inner sep=2cm,fill overzoom image=collaborators/heinrich.jpg] (A) {};
 %   \end{tikzpicture}
 %   Heinrich
 %  \end{center}
 % \end{minipage}%
 ...
 %  \begin{center}
 %   \begin{tikzpicture}
 %    \node[circle,draw,inner sep=2cm,fill overzoom image=collaborators/stark.jpg] (A) {};
 %   \end{tikzpicture}
 %   Stark
 %  \end{center}
 % \end{minipage}%
 ...
 %  \begin{center}
 %   \begin{tikzpicture}
 %    \node[circle,draw,inner sep=2cm,fill overzoom image=collaborators/cranmer.png] (A) {};
 %   \end{tikzpicture}
 %   Cranmer
 %  \end{center}
 % \end{minipage}%
